...
/// Ugashik heights use NOAA's harmonic prediction at the exact capture minute.
/// Event labels separately describe the nearest high or low tide.
/// Sources and derivation: docs/egegik-capture-tides.md and docs/ugashik-capture-tides.md.

...
public struct RegistrationEstimatorConfig: Equatable {
    ...
    public static func `default`() -> RegistrationEstimatorConfig {
        ...
        for k in dailyRatioDrivenDistricts {
            // Use property assignment to avoid Swift argument-order constraints in the override initializer.
...
public enum RegistrationEstimator {
    ...
    public static func estimatePostWindowRegistration(
        ...
        let dkNorm = dk.replacingOccurrences(of: "-", with: "_")
        let isTogiak = (dkNorm == "togiak")
        let isDailyRatioDistrict = (dkNorm == "naknek_kvichak" || dkNorm == "egegik" || dkNorm == "ugashik" || dkNorm == "nushagak")
